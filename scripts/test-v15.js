...
assert(html.includes('/atendimento-v15.js?v=1500'), 'Asset JS V15 não está versionado em 1500.');
assert(html.includes('/atendimento-v15.css?v=1500'), 'Asset CSS V15 não está versionado em 1500.');
...
for (const token of [
  'POLL_INTERVAL_MS = 5000', 'Assumir atendimento', 'Devolver esta conversa para a IA?',
...
assert(pkg.version === '15.0.0', 'Versão do painel precisa ser 15.0.0.');
