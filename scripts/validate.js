...
assert(html.includes('?v=1500'), 'Os assets V15 devem usar cache version 1500.');
...
assert(packageJson.version === '15.0.0', 'A versão do pacote deve ser 15.0.0.');
assert(packageJson.scripts['migrate:panel'] && packageJson.scripts.preflight, 'Scripts de implantação ausentes.');

console.log('Validação V15 concluída: base V14.1, Central de Divulgação e atendimento humano estão consistentes.');
