...
function setView(name) {
  if (!currentUserIsAdmin() && ['audit', 'prospecting', 'publications', 'monitoring', 'users'].includes(name)) name = 'dashboard';
...
async function loadCurrentUser() {
  ...
  if (role !== 'ADMIN' && ['audit', 'prospecting', 'publications', 'monitoring', 'users'].includes(state.activeView)) setView('dashboard');
}
