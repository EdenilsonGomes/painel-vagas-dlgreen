...
> **Hotfix 12.0.1:** corrige o erro PostgreSQL `42P08` (`text versus character varying`) na aprovação. Se `npm run migrate:panel` e `npm run preflight` já passaram no deploy da V12, não existe nova alteração de banco: basta publicar este código e reiniciar o painel.
