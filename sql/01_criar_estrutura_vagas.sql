...
CREATE TABLE IF NOT EXISTS vagas (
    ...
    sexo VARCHAR(20) NOT NULL DEFAULT 'UNISSEX',
    descricao TEXT,
    cidade VARCHAR(100),
    ...
    possui_insalubridade BOOLEAN NOT NULL DEFAULT FALSE,
    ...
    exigir_experiencia_compativel BOOLEAN NOT NULL DEFAULT TRUE,
    ...
    CONSTRAINT vagas_percentual_insalubridade_valido
        CHECK (percentual_insalubridade IS NULL OR (percentual_insalubridade >= 0 AND percentual_insalubridade <= 100))
);
